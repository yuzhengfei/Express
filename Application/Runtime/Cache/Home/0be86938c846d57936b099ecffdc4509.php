...
<div id="dcWrap">
 ...
 <div id="head">
  ...
  <div class="nav">
   <ul>
    <li><a href="/goods/index.php/Home/Addgoods/doLogout">清除缓存</a></li>
   </ul>
   <ul class="navRight">
    <li class="M noLeft"><a href="JavaScript:void(0);">您好，admin</a>
    </li>
    <li class="noRight"><a href="log/goods/index.php/Home/Addgoods/doLogout">退出</a></li>
   </ul>
  </div>
 </div>
</div>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>物资列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/goods/index.php/Home/index" class="actionBtn">物资列表</a>添加物品</h3>
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">物品名称</td>
       <td>
        <input type="text" name="name" id="name" value="" size="80" class="inpMain" />
       </td>
      </tr>      
      <tr>
       <td align="right" valign="top">物品描述</td>
       <td>    
        <textarea name="content" style="width:780px;height:400px;" id="info" class="textArea"></textarea>
       </td>
      </tr>
      <tr>
       <td></td>
