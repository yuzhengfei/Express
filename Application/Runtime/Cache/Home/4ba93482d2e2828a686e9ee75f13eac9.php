...
<script type="text/javascript" src="/goods/Public/js/inorder.js"></script>
...
<div id="dcWrap">
 ...
 <div id="head">
  ...
  <div class="nav">
   <ul>
    <li><a href="/goods/index.php/Home/Inorder/doLogout">清除缓存</a></li>
   </ul>
   <ul class="navRight">
    <li class="M noLeft"><a href="JavaScript:void(0);">您好，admin</a>
    </li>
    <li class="noRight"><a href="log/goods/index.php/Home/Inorder/doLogout">退出</a></li>
   </ul>
  </div>
 </div>
</div>
...
<div id="urHere">物资管理系统<b>></b><strong>物资列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/goods/index.php/Home/Listorder" class="actionBtn">物资列表</a>添加入库单</h3>
