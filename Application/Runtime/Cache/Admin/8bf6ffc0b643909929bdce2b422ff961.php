 ...
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="/express/index.php/Admin/Notice/doLogout">退出</a></li>
   </ul>
  </div>
 </div>
</div>
    ...
    <h3>公告发布</h3>
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" name="title" id="title" value="" size="80" class="inpMain" />
       </td>
      </tr>  
      ...
      <tr>
       ...
       <td>    
        <textarea name="content" style="width:750px;height:200px;" id="notice" class="textArea"></textarea>
       </td>
      </tr>
      ...
      <tr>
       <td></td>
       <td>
        <input name="submit" class="btn" type="submit" id="add_btn" value="发布" />
       </td>
      </tr>
     </table>
</div>
