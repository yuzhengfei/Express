 ...
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="/express/index.php/Admin/Listperson/doLogout">退出</a></li>
   </ul>
  </div>
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <th width="150" align="center">职位</th>
        <th width="80" align="center">用户名</th>
        <th width="80" align="center">操作</th>
      </tr>
      <?php if(is_array($userArr)): $i = 0; $__LIST__ = $userArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($item["id"]); ?>">
        ...
        <td align="center">
           <a href="javascript:void;" class="delete_btn">离职处理</a>
        </td>
      </tr>
