 ...
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="/express/index.php/Admin/Position/doLogout">退出</a></li>
   </ul>
  </div>
 </div>
</div>
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <h3>添加职位</h3>
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <tr>
       <td width="90" align="right">* 职位名称：</td>
       <td>
      ...
      <tr>
       <td align="right" valign="top">* 职位简介：</td>
       <td>    
        <textarea name="content" style="width:520px;height:50px;" id="info" class="textArea"></textarea>
       </td>
      </tr>    
