...
<script type="text/javascript" src="/express/Public/js/position.js"></script>
 ...
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="/express/index.php/Admin/Listposition/doLogout">退出</a></li>
   </ul>
  </div>
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <th width="80" align="center">职位名称</th>
        <th width="80" align="center">简介</th>
        <th width="80" align="center">操作</th>
      </tr>
      <?php if(is_array($positionArr)): $i = 0; $__LIST__ = $positionArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($item["id"]); ?>">
        <td align="center"><?php echo ($item["id"]); ?></td>
        <td align="center"><?php echo ($item["name"]); ?></td>
        <td align="center"><?php echo ($item["info"]); ?></td>
        <td align="center">
            <a href="javascript:void;" class="delete_btn">撤销职位</a>
        </td>
