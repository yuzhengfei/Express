...
<script type="text/javascript" src="/express/Public/js/search.js"></script>
 ...
 <div id="head">
  <div class="logo"><a href="index.html"><!-- img src="/express/Public/img/dclogo.gif" alt="logo"> --><h1 style="    font-size: 25px;
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="/express/index.php/Admin/Search/doLogout">退出</a></li>
   </ul>
  </div>
 </div>
</div>
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <h3>快件路由状态查询</h3>
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <tr>
       <td width="100" align="right">请输入快递单号：</td>
       <td >
        <input type="text" name="name" id="expressnumber" value="<?php echo ($search); ?>" size="30" class="inpMain" />
        <input name="submit" class="btn" type="submit" id="searchnumber" value="查询" />
       </td>       
      </tr>
