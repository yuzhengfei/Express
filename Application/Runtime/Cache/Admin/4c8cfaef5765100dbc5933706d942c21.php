...
<script type="text/javascript" src="/express/Public/js/provider.js"></script>
 ...
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="/express/index.php/Admin/Listnotice/doLogout">退出</a></li>
   </ul>
  </div>
...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <th width="80" align="center">内容</th>
        <th width="80" align="center">发布时间</th>
        <th width="80" align="center">操作</th>
      </tr>
      <?php if(is_array($noticeArr)): $i = 0; $__LIST__ = $noticeArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($item["id"]); ?>">
        <td align="center"><?php echo ($item["title"]); ?></td>
        <td align="center"><?php echo ($item["author"]); ?></td>
        <td align="center"><?php echo ($item["notice"]); ?></td>
        <td align="center"><?php echo ($item["create_at"]); ?></td>
        <td align="center">
                  <a href="/express/index.php/Admin/Editnotice?id=<?php echo ($item["id"]); ?>">编辑</a> | <a href="javascript:void;" class="delete_btn">删除</a>
                 </td>
      </tr>
