...
<script type="text/javascript" src="/express/Public/js/notice.js"></script>
...
<div id="dcWrap">
 ...
 <div id="head">
  ...
  <div class="nav">
   <ul>
    <li><a href="/express/index.php/Admin/Editnotice/doLogout">清除缓存</a></li>
   </ul>
   <ul class="navRight">
    <li class="M noLeft"><a href="JavaScript:void(0);">您好，admin</a>
    </li>
    <li class="noRight"><a href="/express/index.php/Admin/Editnotice/doLogout">退出</a></li>
   </ul>
  </div>
 </div>
</div>
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <li ><a href="/express/index.php/Admin/Editcar"><i class="productCat"></i><em>车辆分发</em></a></li> 
 </ul>
    ...
    <h3>修改通知</h3>
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <tr>
       ...
       <td>
        <div name = "noticeId" hidden>
         <input type="text" name="id" id="id" value="<?php echo ($noticeId); ?>" />
        </div>
        <div  name="noticeTitle">
        <input type="text" name="title" id="title" value="<?php echo ($noticeTitle); ?>" size="80" class="inpMain" />
        </div>
       </td>
      </tr> 
      ...
      <tr>
       ...
       <td>
        <div  name="noticeTitle">
        <input type="text" name="author" id="author" value="<?php echo ($noticeAuthor); ?>" size="80" class="inpMain" readonly="readonly" />
        </div>
       </td>
      </tr> 
      ...
      <tr>
       ...
       <td> 
        <div name="noticeNotice">   
        <textarea name="content" style="width:750px;height:200px;" id="notice" class="textArea"><?php echo ($noticeNotice); ?></textarea>
        </div>
       </td>
      </tr>
      ...
      <tr>
       <td></td>
       <td>
        <input name="submit" class="btn" type="submit" id="editnotice" value="提交" />
       </td>
      </tr>
