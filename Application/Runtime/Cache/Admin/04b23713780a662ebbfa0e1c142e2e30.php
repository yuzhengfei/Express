 ...
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="/express/index.php/Admin/Car/doLogout">退出</a></li>
   </ul>
  </div>
...
<div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">公告：<strong>欢迎您来到智慧物流管理网站！如有问题请拨打24小时咨询电话：13888888888。</strong> </div>   
    ...
    <h3>车辆信息添加</h3>
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" name="name" id="carnumber" value="" size="80" class="inpMain" />
       </td>
      </tr>
